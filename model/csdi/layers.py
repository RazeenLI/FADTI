...
class ResidualBlock(nn.Module):
    def __init__(
        ...
        self.time_layer = get_torch_trans(heads=num_heads, layers=1, channels=num_channels)
        self.feature_layer = get_torch_trans(heads=num_heads, layers=1, channels=num_channels)
    ...
    def forward(
        ...
        y = self.forward_feature(y, base_shape) # (batch_size, num_channels, num_features * num_steps)
